###------------------------------------------------------------------------------------------------------###
### This script was downloaded from https://raw.githubusercontent.com/ANGSD/angsd/master/R/estAvgError.R ###
### and is used to get the output from angsd abbababa2 in human readable form                            ###
###------------------------------------------------------------------------------------------------------###
